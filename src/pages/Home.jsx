        ...
        <div className='max-w-6xl mx-auto'>
          ...
          <div className='text-center mb-28'>
            ...
            <motion.p
              ...
              adaptive difficulty and real-time preformance evaluation.
            </motion.p>
          ...
          <div className='flex flex-col md:flex-row justify-center items-center gap-10 mb-28'>
            {
              [
                ...
                ${index === 0 ? "rotate-[-4deg]" : ""}
                ${index === 1 ? "rotate-[-3deg] md : md:-mt-6 shadow-xl" : ""}
                ${index === 2 ? "rotate-[-3deg]" : ""} 
                `}>
                  <div className='absolute -top-8 left-1/2 -translate-x-1/2 bg-white border-2 border-green-500
            ...
            <div className='grid md:grid-cols-2 gap-10'>
              {
                [
                  ...
                  },
                  {
                    ...
                    desc: "Detailed strnggths , weakness and improvement insights. "
                  },
                  {
                    image: resumeImg,
                    icon: <BsFileEarmarkText size={20} />,
                  ...
                  },
                  {
                    ...
                    desc: "Track progress with performance grap analysis."
                  },
                ].map((item, index) => (
                  <motion.div key={index}
                    initial={{ opacity: 0, y: 30 }}
                  ...
                  shadow-sm hover:shadow-xl transition-all'>
                    <div className='flex flex-col md:flex-row items-center gap-8'>
                      <div className='w-full md:w-1/2 flex justify-center'>
                        <img src={item.image} alt='page' className='w-full h-auto object-contain max-h-64' />
                      </div>
