...
const Step1SetUp = ({ onStart }) => {
    ...
    const handleUploadResume = async () => {
        ...
        try {
            const result = await axios.post(ServerUrl + "/resume", formdata, { withCredentials: true })
                ...
                >
                    ...
                    <div className='space-y-6'>
                        <div className='relative'>
                            ...
                            <input type='text' placeholder='Enter role' className='w-full pl-12 pr-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-green-500 outline-none
                            transition'
                        ...
                        <div className='relative'>
                            ...
                            <input type='text' placeholder='Enter experience' className='w-full pl-12 pr-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-green-500 outline-none
                            transition'
                        ...
                        {!analysisDone && (
                            ...
                            >
                                <FaFileUpload size={48} className='text-4xl mx-auto text-green-600 mb-3' />
